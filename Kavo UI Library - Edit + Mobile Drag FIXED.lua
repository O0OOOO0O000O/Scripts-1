-- This script isn't made by me, all credits go to it's owner
...
local themeStyles = {
    ...
    GrapeTheme = {
        ...
        TextColor = Color3.fromRGB(255,255,255),
        ElementColor = Color3.fromRGB(96, 70, 110)
    },
    Ocean = {
    ...
    Serpent = {
        SchemeColor = Color3.fromRGB(19, 190, 158),
        Background = Color3.fromRGB(39, 60, 81),
        Header = Color3.fromRGB(48, 73, 95),
        TextColor = Color3.fromRGB(255,255,255),
        ElementColor = Color3.fromRGB(48, 73, 95)
    }
}
local oldTheme = ""
